...
public:
    ...
    LotsOfLinesApp(const QString& openFile, bool parallel, bool collocatedPaired, bool radialPaired, bool shiftedPaired, QWidget* parent = 0);
...
public slots:
    ...
    void onVisualizationOptionsChanged(const std::string&);
